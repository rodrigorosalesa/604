...
bad_country_cases <- data[data$new_cases_smoothed_per_million < tenth_percentile,]
...
bad_country_deaths <- data[data$new_deaths_smoothed_per_million < tenth_percentile,]
