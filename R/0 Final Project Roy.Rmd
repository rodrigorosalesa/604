...
#### Prediction
The purpose of building a model is to have the ability to predict unknown scenarios, using the model we created we will predict the average daily covid-19 cases for a specific country that has the mean of all our predictor terms.
```{r}
df = data.frame(population=mean(covid_agg$population), aged_65_older=mean(covid_agg$aged_65_older), gdp_per_capita=mean(covid_agg$gdp_per_capita))
...
#### Prediction
The purpose of building a model is to have the ability to predict unknown scenarios, using the model we created we will predict the average daily covid-19 deaths for a specific country that has the mean of all our predictor terms.
```{r}
df = data.frame(population=mean(covid_agg$population), human_development_index=mean(covid_agg$human_development_index))
