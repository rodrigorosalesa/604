...
Our goals for these questions is to create the best fitting model for the identified response variables using either population-related metrics or daile reported covid-19 data.
...
[Table 1: Summary of Data Pipeline (Our World In Data, 2022)](Table_1.PNG)
...
**Analysis**
- Question 1 Multiple Linear Regression Models (Rodrigo Rosales Alvarez)
...
- Question 2 Multiple Linear Regression Models 
  ...
  - Model 2 (Ann Siddiqui)
    - Model 2 Assumptions
    - Model 2 Box-Cox Transformation

Each team member did one full model for two reasons: first, to practice everything that we learnt in DATA 603; second, to ensure that the person completing all analyses and conclusions for each model is the person with the best understanding of that model.  
...
For this reason we are going to build two Multiple Linear Regressions Models, one for Average Daily Covid-19 Cases and one for Average Daily Covid-19 Deaths, using the tools we learnt during class.
...
Before declaring the final model, the assumptions of normality, homoscedasticity, linearity, and independence were checked, and the model was additionally checked for outliers. From the tests and plots used in this section, it was determined that the model failed both the normality and homoscedasticity assumptions, while the linearity, independence, and outlier assumptions were either satisfied or inconclusive. 
...
Before declaring the final model, the assumptions of normality, homoscedasticity, linearity, and independence were checked, and the model was additionally checked for outliers. From the tests and plots used in this section, it was determined that the model failed both the normality and homoscedasticity assumptions, while the linearity, independence, and outlier assumptions were all satisfied.   
