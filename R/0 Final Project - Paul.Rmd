...
bad_countries_cases = avg_daily_cases_per_million$location[avg_daily_cases_per_million$new_cases_smoothed_per_million < p5_cases]
...
bad_countries_deaths = avg_daily_deaths_per_million$location[avg_daily_deaths_per_million$new_deaths_smoothed_per_million < p5_deaths]

bad_countries_deaths

bad_country_list <- append(bad_countries_cases, bad_countries_deaths)

unqique_bad_country_list = unique(bad_country_list)

covid_data <- covid_raw[!covid_raw$location %in% unqique_bad_country_list, ]
```
